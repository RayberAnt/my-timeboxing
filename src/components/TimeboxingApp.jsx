...
export default function TimeboxingApp() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4 flex flex-col">
      ...
      <footer className="w-full bg-white border-t border-indigo-200 py-4 mt-8">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between text-sm text-gray-500">
          <div className="mb-2 md:mb-0">© {new Date().getFullYear()} My Timeboxing. Todos los derechos reservados.</div>
          <div>
            Hecho con ♥️ por RayberAnt.
          </div>
        </div>
      </footer>
    </div>
